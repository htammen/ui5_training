sap.ui.define([
	...
	return BaseController.extend("de.tammenit.ui5.training.controller.CreateEntity", {
		...
		onSave: function() {
			...
			if (this._oViewModel.getProperty("/mode") === "edit") {
				...
				oModel.attachEventOnce("batchRequestCompleted", this._endRequest.bind(this));
				oModel.attachEventOnce("requestCompleted", this._endRequest.bind(this));
			}
			oModel.submitChanges();
		},
		
		_endRequest: function(oEvent) {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("customers", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("customers", oData);
