...
sap.ui.define([
	...
	"sap/m/MessageBox",
	"de/tammenit/ui5/training/model/grouper",
	"de/tammenit/ui5/training/model/GroupSortState"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("de.tammenit.ui5.training.controller.Master", {
		...
		onInit: function() {
			...
			this._oGroupSortState = new GroupSortState(oViewModel, grouper.id(this.getResourceBundle()));
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("de.tammenit.ui5.training.view.ViewSettingsDialog", this);
