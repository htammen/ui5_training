sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/tammenit/ui5/training/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#CustomerOvierview-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#CustomerOvierview-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("de.tammenit.ui5.training.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["de/tammenit/ui5/training/localService/mockserver"], function(mockserver) {
